...
func VerifyPassword(userPassword string, givenPassword string) (bool, string) {
	...
	if err != nil {
		valid = false
		msg = "Login or Password in incorrect"
	}
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context){
		...
		_, inserterr := UserCollection.IsertOne(ctx, user)
		if inserterr != nil {
...
func Login() gin.HandlerFunc {
	return func (c *gin.Context)  {
		...
		token, refreshtoken, _ := generate.TokenGenerator(*founduser.Email, *founduser.Firts_Name, *founduser.Last_Name, founduser.User_ID)
		defer cancel()
...
func SearchProductByQuery() gin.HandlerFunc {
	return func(c *gin.Context){
		...
		if err != nil {
			c.IndentedJSON(404, "Something get wrong")
			return
		}
